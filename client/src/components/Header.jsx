  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>AutoBG is your go-to, high-quality background remover, <br className='max-sm:hidden' /> making it easy to <b>cut out a picture</b> and isolate the <br/> background with incredible accuracy.</p>
            <div>
